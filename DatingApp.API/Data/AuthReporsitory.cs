...
namespace DatingApp.API.Data
{
    public class AuthReporsitory : IAuthRepository
    {
        ...
        public async Task<User> Register(User user, string password)
        {
            ...
            CreatePasswordash(password, out passwordHash, out passwordSalt);
        ...
        private void CreatePasswordash(string password, out byte[] passwordHash, out byte[] passwordSalt)
        {
